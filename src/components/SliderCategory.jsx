...
import { Barbecue, Burger, Drinks, Cupcake, Tacos, Shawarma, Sushi, 
  IceCream, Sandwich,Diet,FreeLactoz, Pizza,VegetablesSalad,Vegetables,Food } from '../Icons/BunchIcons';
    ...
    <div className='flex items-center justify-content md:ltr:pl-5 md:rtl:pr-5 relative md:my-0 my-10 overflow-y-auto'>
      {
        names.map((name,index) => (
          <button key={index} type='submit' onClick={() => {
            ...
            }} className={`flex flex-col px-4 bg-gray-200 rounded-lg  mx-2 hover:bg-[#f88f33] ${names[index].active ? "bg-[#f88f33]"  : "" } py-3 items-center  justify-content`}>
